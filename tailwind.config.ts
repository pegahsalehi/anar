  ...
  theme: {
    extend: {
      colors: {
        ...
        "effective-badge": "rgb(var(--effective-badge) / <alpha-value>)",
        "effective-badge-border": "rgb(var(--effective-badge-border) / <alpha-value>)",
        "effective-badge-foreground": "rgb(var(--effective-badge-foreground) / <alpha-value>)",
